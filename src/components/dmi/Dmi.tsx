...
function Dmi() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("/dmi/data/dmi_2023_clusters.csv");
        ...
        const response2 = await fetch("/dmi/data/correlations.csv");
  ...
  return (
    <div className="w-full h-full py-10 bg-white z-50 flex flex-col items-center">
      <FilterButtons
